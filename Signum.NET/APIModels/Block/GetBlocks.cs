...
{
    #region Interface
    public interface IGetBlocks : IBaseRequest
    {
        public List<IBlockGB> Blocks { get; }
    }

    public interface IBlockGB
    {
    ...
    public class GetBlocks : BaseRequest, IGetBlocks
    {

        #region API Properties     

        [JsonPropertyName("blocks")]
        public List<BlockGB>? Blocks { get; set; }
        ...
        List<IBlockGB> IGetBlocks.Blocks => new(Blocks);
